...
static char versionid[] MAYBE_UNUSED =
  "$Id: convert.c 3635 2009-04-22 02:45:30Z haase $";
...
struct U8_TEXT_ENCODING *encodings, *utf8_encoding=NULL;
struct U8_TEXT_ENCODING *ascii_encoding=NULL, *latin1_encoding=NULL;
